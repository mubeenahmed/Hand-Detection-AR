...
import com.example.ajinkya.cvisionapp.shapes.Circle;
import com.example.ajinkya.cvisionapp.shapes.Cube;
import com.example.ajinkya.cvisionapp.shapes.Shape;
import com.example.ajinkya.cvisionapp.shapes.Texture;
...
public class GLRenderer implements GLSurfaceView.Renderer {
   ...
   // private Cube mCube = new Cube();
    ...
    public GLRenderer(Context context, Shape shape) {
        this.shape = shape;
